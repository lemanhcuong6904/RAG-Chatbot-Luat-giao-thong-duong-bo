...
RAG_PRERAG_PROVIDER = os.getenv("RAG_PRERAG_PROVIDER", RAG_LLM_PROVIDER).lower()
...
RAG_STRUCTURED_FACT_USE_WITH_LLM = os.getenv("RAG_STRUCTURED_FACT_USE_WITH_LLM", "false").lower() == "true"
RAG_STRUCTURED_TABLE_ENABLED = (
    RAG_STRUCTURED_LOOKUP_ENABLED and os.getenv("RAG_STRUCTURED_TABLE_ENABLED", "true").lower() == "true"
)
RAG_STRUCTURED_TABLE_USE_WITH_LLM = os.getenv("RAG_STRUCTURED_TABLE_USE_WITH_LLM", "false").lower() == "true"
...
RAG_STRUCTURED_SANCTION_REQUIRE_LLM_PLAN = (
    os.getenv("RAG_STRUCTURED_SANCTION_REQUIRE_LLM_PLAN", "true").lower() == "true"
)
RAG_DETERMINISTIC_ANSWER_USE_WITH_LLM = (
    os.getenv("RAG_DETERMINISTIC_ANSWER_USE_WITH_LLM", "false").lower() == "true"
)
