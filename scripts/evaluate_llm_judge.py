...
CACHE_PATH = ROOT_DIR / "data" / "evaluation_set_2" / "llm_judge_scores_bge_m3.jsonl"
REPORT_PATH = ROOT_DIR / "data" / "evaluation_set_2" / "EVALUATION_REPORT_LLM_JUDGE_bge_m3.md"
